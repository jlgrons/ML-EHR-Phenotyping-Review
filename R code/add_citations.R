...
citations <- read.csv('../Data/citations.csv', header = FALSE)
...
annotations_all <- read.csv("../Data/article_charting.csv", skip = 1)
...
# Save the file.
write.csv(my_citations, "../Data/article_charting_with_citations.csv")
